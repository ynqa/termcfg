# Contributing to termcfg

We welcome contributions to "termcfg" and greatly appreciate your help in making
...
[termcfg repository](https://github.com/ynqa/termcfg) to create a copy of the
...
```bash
git clone https://github.com/<your_username>/termcfg.git
```
...
[termcfg Pull Request page](https://github.com/ynqa/termcfg/pulls) and click the
...
Thank you for considering contributing to "termcfg"!
